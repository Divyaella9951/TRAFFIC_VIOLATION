# TRAFFIC_VIOLATION
AI-based Smart Traffic Monitoring System using YOLOv8, OpenCV, PyTorch, and Flask to detect helmet violations, seatbelt usage, driver distractions, and automatically extract license plate numbers with OCR,alert the message and fine calculation.
